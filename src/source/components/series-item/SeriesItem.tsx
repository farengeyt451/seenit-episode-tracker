  ...
  return (
    <a
      ...
      className={clsx(
        ...
        isActive
          ? 'light:from-blue-200/90 light:via-sky-200/80 light:to-slate-50/70 light:border-sky-200 cursor-default bg-gradient-to-r from-purple-900/60 via-violet-800/40 to-blue-900/20'
