...
export const Sidebar: FC = (): JSX.Element => {
  ...
  const showSearchMode = isSearchMode || (isSidebarOpen && !seriesData?.length);
    ...
    <div data-tag="sidebar">
      ...
      >
        ...
        >
          ...
          >
            <div className="relative h-lh w-10">
              <Transition
                show={!showSearchMode}
              ...
              >
                <div
                  className={clsx(
                    ...
                    'light:bg-linear-to-r from-purple-500 to-pink-700',
                  )}
                >
                  &lsaquo;My&rsaquo;
                </div>
              ...
              >
                <div
                  className={clsx(
                    ...
                    'light:bg-linear-to-r from-blue-500 to-blue-700',
                  )}
                >
                  Find
                </div>
