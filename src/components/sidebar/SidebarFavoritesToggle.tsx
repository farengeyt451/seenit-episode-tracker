  ...
  return (
    <Button
      ...
      className={clsx(
        ...
        showOnlyFavorites &&
          'light:from-amber-100/90 light:via-yellow-100/90 light:to-orange-100/90 light:text-amber-900 light:ring-amber-200 bg-linear-to-r from-amber-500/20 via-yellow-500/20 to-orange-400/20 text-yellow-300 ring-1 ring-amber-400/40',
      )}
    >
